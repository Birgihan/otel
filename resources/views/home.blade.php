        ...
        <div class="container">
          <div class="row slider-text align-items-end">
            <div class="col-md-10 col-sm-12 ftco-animate mb-4">
              <p class="breadcrumbs"><span class="mr-2"><a href="home">Anasayfa</a></span> <span>İLETİŞİM</span></p>
      ...
      <div class="container bg-light">
        <div class="row d-flex mb-5 contact-info">
          <div class="col-md-12 mb-4">
            <h2 class="h4">ULAŞIM ADRESİ ve TELEFON NUMARASI</h2>
          </div>
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Adres:</span> DENİZLİ/PAMUKKALE</p>
          </div>
          <div class="col-md-3">
            <p><span>Telefon:</span> <a href="tel://1234567920">05356435028</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:info@yoursite.com">birgihank@gmail.com</a></p>
          </div>
          <div class="col-md-3">
