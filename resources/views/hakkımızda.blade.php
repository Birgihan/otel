        ...
        <div class="container">
          <div class="row slider-text align-items-end">
            <div class="col-md-10 col-sm-12 ftco-animate mb-4">
              <p class="breadcrumbs"><span class="mr-2"><a href="home">Anasayfa</a></span> <span></span></p>
              <h1 class="mb-3">HAKKIMIZDA</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="section-2-blocks-wrapper row d-flex">
          ...
          <div class="text col-lg-6 order-first ftco-animate">
            <div class="text-inner align-self-start">
              <span class="subheading">NEREDEYİZ ? </span>
              <h3 class="heading">OTELİMİZE HOŞGELDİNİZ</h3>
              <p>Bu kısıma otelimizle ilgili veriler girilecektir. Şimdilik boştur yapılacak siteye göre dolacaktır.</p>

              <p>Devamı olarakta buraya bir şeyler yazılarak bu sayfa tamamlanacak loremipsum loremipsum loremipsum loremipsum loremipsum loremipsum
